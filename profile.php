...
if(isset($_SESSION['views']))
 ...
 ?>
        ...
        <tr>
          <td><strong>College Name : </strong><b><?php if(isset($_REQUEST['$cname'])){echo $cname ; } else echo "none"; ?></b></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        </tr>
      ...
      <tr>
        <td colspan="2"><strong>College Name : </strong><b><?phpif(isset($_REQUEST['$cname'])){ echo $cname ; }?></b></td>
      </tr>
      <tr>
        <td width="51%"><strong>City :<?php if(isset($_REQUEST['$cname'])){ echo $_GET["fmes"];} else echo "none"; ?></strong></td>
        <td width="49%"><?phpif(isset($_REQUEST['$city'])){ echo $city;} ?></td>
        </tr>
      <tr>
        <td height="23"><strong>State:</strong></td>
        <td><?php if(isset($_REQUEST['$state'])){ echo $state;} else echo "none";  ?></td>
        </tr>
      <tr>
        <td height="23"><strong>Pincode:</strong></td>
        <td><?php if(isset($_REQUEST['$pincode'])){ echo $pincode;} else echo "none"; ?></td>
        </tr>
      <tr>
        <td height="23"><strong>Country:</strong></td>
        <td><?php if(isset($_REQUEST['$country'])){ echo $country;} else echo "none"; ?></td>
        </tr>
      </table></td>
