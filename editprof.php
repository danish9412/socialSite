...
{
  echo "asd";
  mysql_query("UPDATE stuacc SET firstname='$_POST[fname]',lastname='$_POST[lname]' WHERE id= $_SESSION[iduser]");
  if(mysql_affected_rows()>0)
      echo "Record Updated Successfully";
  mysql_query("UPDATE profile SET city ='$_POST[city]',	state='$_POST[state]',pincode=$_POST[pincode],country='$_POST[loc]',hschool='$_POST[hschool]',coluni='$_POST[coll]',course='$_POST[hschool2]' WHERE userid=$_SESSION[iduser]");
if(mysql_affected_rows()>0)
{
  echo "Record Updated Successfully";
...
$conrec = mysql_query("SELECT * FROM college where id=$_SESSION[iduser]");
$row=mysql_fetch_assoc($conrec);
?>
...
<!-- body  content -->
  ...
  <tr>
    <td width="17%" rowspan="7" align="left" valign="top" bgcolor="#CCCCCC">
      <?php include("profileleft.php"); ?></td>
  ...
  <table width="68%" border="1" align="center">
    ...
    <tr>
      ...
      <td><input name="city" type="text" id="city" size="40" value="<?php if(isset($row))
       { echo $row['city'];
       } else echo "none"; ?>" /></td>
      </tr>
    <tr>
